...
nmap { '<Tab>', ':BufferLineCycleNext<CR>', silent }
nmap { '<S-Tab>', ':BufferLineCyclePrevious<CR>', silent }
nmap { '<leader>tmh', ':BufferLineMovePrev<CR>', silent }
nmap { '<leader>tml', ':BufferLineMoveNext<CR>', silent }
