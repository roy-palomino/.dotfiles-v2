...
-- require("luasnip/loaders/from_vscode").load({ paths = { "/home/roier/.vim/plugged/friendly-snippets/snippets/vue.json" } })

-- local snip = ls.parser.parse_snippet

-- ls.add_snippets({"all", "============ $0 ============"})
...
--   vue = {
--     snip("scaffold", "<script lang=\"ts\">\nimport { defineComponent } from \"vue\"\n\nexport default defineComponent({\n  name: \"$1\",\n  setup() {\n    $0\n  },\n})\n</script>\n\n<template>\n</template>\n\n<style lang=\"scss\" scoped>\n</style>"),
--     snip("func", "const $1 = ($2) => {\n  $0\n}"),
--   },
--   dart = {
--     snip("stless", "Stateless widget gaaa")
--   }
-- }
--
--
